...
var accountsMerge = function(accounts) {
    //用两个map存放对应关系
    //email->index: johnsmith->0 john00->1 johnnybravo->2 john_newyork->3 mary->4
    //email->name: johnsmith->john john00->john .......
	...
	//index-emails: 0->[johnsmith,john00,john_newyork] 2->[johnnybravo] 4->[mary]
